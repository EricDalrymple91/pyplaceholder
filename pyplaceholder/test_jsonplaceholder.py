...
class TestJSONPlaceholder(object):
    ...
    def test_get_albums(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/albums', json=[{'id': 1}])
    ...
    def test_get_comments(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/comments', json=[{'id': 1}])
    ...
    def test_get_posts(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/posts', json=[{'id': 1}])
    ...
    def test_get_post(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/posts/1', json={'id': 1})
    ...
    def test_get_post_comments(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/posts/1/comments', json={'id': 1})
    ...
    def test_create_post(self, **kwargs):
        kwargs["http_mocker"].post('https://jsonplaceholder.typicode.com/posts', json={'id': 1})
    ...
    def test_update_post(self, **kwargs):
        kwargs["http_mocker"].put('https://jsonplaceholder.typicode.com/posts/1', json={'id': 1})
    ...
    def test_delete_post(self, **kwargs):
        kwargs["http_mocker"].delete('https://jsonplaceholder.typicode.com/posts/1', json={'id': 1})
    ...
    def test_get_todos(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/todos', json=[{'id': 1}])
    ...
    def test_get_users(self, **kwargs):
        kwargs["http_mocker"].get('https://jsonplaceholder.typicode.com/users', json=[{'id': 1}])
